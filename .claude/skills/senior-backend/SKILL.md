...
For **database schema design and migration planning**, use the `database-architect` agent FIRST before using the implementation tools in this skill.

| Component | Role |
|-----------|------|
| **database-architect Agent** | PLANNING - Designs database schemas, indexes, relationships, and migration strategies |
| **This Skill** (`senior-backend`) | IMPLEMENTATION - Provides tools for executing migrations and optimizing queries |

**Recommended Workflow:**
1. Invoke `database-architect` agent to create the schema plan
2. Use `database_migration_tool.py` from this skill to implement migrations
3. Use `database_optimization_guide.md` for query tuning
...
<!-- mixin-source: development-workflow v1.0.0 -->
...
<!-- mixin-source: best-practices-general v1.0.0 -->
...
<!-- mixin-source: common-commands v1.0.0 -->
## Common Commands
...
<!-- mixin-source: troubleshooting v1.0.0 -->
## Troubleshooting
...
<!-- mixin-source: resources-template v1.0.0 -->
## Resources
